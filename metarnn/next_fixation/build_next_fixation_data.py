...
logit. Produces four datasets under output/next_fixation/:
  ...
  next_fixation_long_walk_mixed_10x.csv    adjacent null oracle (10x resampled)
...
from lesion_oracles import walk_mixed, random_oracle  # noqa: E402
...
def main() -> None:
    ...
    t_m, f_m = walk_mixed(t_h, f_h, seed=0, n_repeats=10)
    write(build_next_fixation_long(t_m, f_m), "walk_mixed_10x")
